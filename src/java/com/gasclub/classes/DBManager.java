...
public class DBManager {
    ...
    public static String updateTableRow(String Tablename, HashMap<String, Object> Data, String Condition) throws ClassNotFoundException, SQLException {
        String result = "failed";
        String dataString = "";
        String Columns = "";
        ArrayList<String> Cols = new ArrayList<>();
        ...
        PreparedStatement stmt = null;
        ResultSet rs = null;
        String sql = "Update " + Tablename + " SET " + Columns + " = " + dataString + Condition;
        try {
            con = new JDBCConnector().getConnection();
            stmt = con.prepareStatement(sql);
            for (int count = 0; count < Data.size(); count++) {
